...
const EVENT_TYPES: Array<{
  ...
  { eventType: 'LOGIN', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 25 },
  { eventType: 'LOGIN_ERROR', logLevel: 'WARN', loggerBase: 'org.keycloak.events', category: 'login', weight: 8 },
  { eventType: 'LOGOUT', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 15 },
  { eventType: 'CODE_TO_TOKEN', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 12 },
  { eventType: 'CODE_TO_TOKEN_ERROR', logLevel: 'WARN', loggerBase: 'org.keycloak.events', category: 'login', weight: 3 },
  { eventType: 'REGISTER', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 4 },
  { eventType: 'UPDATE_PASSWORD', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 5 },
  { eventType: 'TOKEN_EXCHANGE', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 8 },
  { eventType: 'REFRESH_TOKEN', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'login', weight: 10 },
  { eventType: 'IMPERSONATE', logLevel: 'WARN', loggerBase: 'org.keycloak.events', category: 'login', weight: 1 },
  { eventType: 'CREATE', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'admin', weight: 3 },
  { eventType: 'UPDATE', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'admin', weight: 4 },
  { eventType: 'DELETE', logLevel: 'WARN', loggerBase: 'org.keycloak.events', category: 'admin', weight: 1 },
  { eventType: 'ACTION', logLevel: 'INFO', loggerBase: 'org.keycloak.events', category: 'admin', weight: 2 },
];

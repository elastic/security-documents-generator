...
export const getFileLineCount = async (filePath) => {
...
export const indexCheck = async (index, body) => {
...
export const ingest = async (index, documents) => {

    ...
    return {
        ...
        "related": {
            "user": [
                userName,
                "jonathan_smith",
                userNameWhitespaceRemoved(userName)
            ]
        },
        "data_stream": {
            "namespace": "default",

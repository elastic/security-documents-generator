...
export const generateMalwareDetectionLog = (config = {}) => {
...
export const generateProcessInjectionLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateBehavioralAnomalyLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateEvasionDetectionLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateMemoryPatternLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
    return {
        '@timestamp': generateTimestamp(timestampConfig),
        'agent.type': 'endpoint',
...
export const generateFileSystemReconLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
    const reconCommands = [
        'dir C:\\Users\\*',
        'ls /home/*',
...
export const generateProcessReconLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateScheduledTaskLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateRegistryRunKeyLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
    const runKeyPaths = [
...
export const generateCredentialAccessLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateLateralMovementLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
    const lateralTools = [
        'psexec.exe',
        'wmic.exe',
...
export default function createEndpointLog(override = {}, config = {}) {
    const logGenerators = [

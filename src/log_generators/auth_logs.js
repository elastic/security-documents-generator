...
export const generateLoginSuccessLog = (config = {}) => {
...
export const generateLoginFailureLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generatePrivilegeEscalationLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export const generateAccountLockoutLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
    return {
        '@timestamp': generateTimestamp(timestampConfig),
        'agent.type': 'winlogbeat',
...
export const generateLinuxAuthLog = (config = {}) => {
    const { hostName = faker.internet.domainName(), userName = faker.internet.username(), timestampConfig, } = config;
...
export default function createAuthLog(override = {}, config = {}) {
    const logGenerators = [

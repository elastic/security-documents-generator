...
function baseCreateAlerts({ userName = 'user-1', hostName = 'host-1', space = 'default', timestampConfig, } = {}) {
...
export default function createAlerts(override, { userName, hostName, space, timestampConfig, } = {}) {
    return {

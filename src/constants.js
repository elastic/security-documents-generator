...
export const RISK_SCORE_DASHBOARD_URL = (entityType) => `/internal/risk_score/prebuilt_content/saved_objects/_bulk_create/${entityType}RiskScoreDashboards`;
...
export const FLEET_EPM_PACKAGES_URL = (packageName, version = 'latest') => {
...
export const SPACE_URL = (space) => `/api/spaces/space/${space}`;
export const ENTITY_ENGINES_URL = '/api/entity_store/engines';
export const ENTITY_ENGINE_URL = (engineType) => `${ENTITY_ENGINES_URL}/${engineType}`;
export const INIT_ENTITY_ENGINE_URL = (engineType) => `${ENTITY_ENGINE_URL(engineType)}/init`;

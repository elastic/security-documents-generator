...
export const INSIDER_THREAT_SCENARIOS = {
    DATA_THEFT_REVENGE: {
 ...
 */
export function generateRandomInsiderThreatScenario() {
 ...
 */
export function getAllInsiderThreatScenarios() {
    return Object.values(INSIDER_THREAT_SCENARIOS);
}
/**
 * Gets insider threat scenarios by motivation
 */
export function getInsiderThreatScenariosByMotivation(motivation) {
    return Object.values(INSIDER_THREAT_SCENARIOS).filter((scenario) => scenario.insider.motivation === motivation);
}
/**
 * Gets insider threat scenarios by risk level
 */
export function getInsiderThreatScenariosByRisk(riskLevel) {
    return Object.values(INSIDER_THREAT_SCENARIOS).filter((scenario) => scenario.activities.some((activity) => activity.risk_level === riskLevel));
}

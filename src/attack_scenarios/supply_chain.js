...
export const SUPPLY_CHAIN_TARGETS = {
    SOFTWARE_LIBRARY: {
        id: 'SOFTWARE_LIBRARY',
 ...
 */
export function generateRandomSupplyChainAttack() {
 ...
 */
export function getAllSupplyChainAttacks() {
    return Object.values(SUPPLY_CHAIN_ATTACKS);
}
/**
 * Gets supply chain attacks by target type
 */
export function getSupplyChainAttacksByTargetType(targetType) {
    return Object.values(SUPPLY_CHAIN_ATTACKS).filter((attack) => attack.target.type === targetType);
}
/**
 * Gets supply chain attacks by sophistication level
 */
export function getSupplyChainAttacksBySophistication(sophistication) {
    return Object.values(SUPPLY_CHAIN_ATTACKS).filter((attack) => attack.sophistication === sophistication);
}

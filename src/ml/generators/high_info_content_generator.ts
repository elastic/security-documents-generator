    ...
    while (this.currentTime <= this.endTime) {
      ...
      if (this.isAnomalousEvent()) {
        ...
        while (count <= burstSize) {
          ...
          const burstDocument = this.addFields(
            burstDoc,
            this.getRandomInteger(burstStartTime, burstStartTime + 10),
          );
          ...
          if (this.analysisField) {
            ...
            burstDocument[this.analysisField] =
              this.getRandomString(stringLength);
          }

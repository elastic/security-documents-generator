...
export const initializeSpace = async (space) => {
...
const alertIndexExistsInSpace = async (space) => {
...
const waitForAlertIndexMapping = async (space, attempts = 5, waitSeconds = 5) => {
    const client = getEsClient();
    const index = getAlertIndex(space);
...
const ensureSpaceExists = async (space) => {

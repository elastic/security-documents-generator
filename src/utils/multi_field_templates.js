 ...
 */
export const MULTI_FIELD_TEMPLATES = {
 ...
 */
export function getFieldsInCategory(category) {
...
export function getTotalFieldCount() {
    return Object.values(MULTI_FIELD_TEMPLATES).reduce((total, category) => total + Object.keys(category).length, 0);
}
/**

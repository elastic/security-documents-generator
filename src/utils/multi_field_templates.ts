...
export const MULTI_FIELD_TEMPLATES: MultiFieldTemplates = {
  ...
  malware_analysis: {
    ...
    'malware.static.yara.family_detected': {
      type: 'string',
      generator: () => faker.helpers.arrayElement(['Trojan.Generic', 'Win32.Emotet', 'Backdoor.Agent', 'Ransomware.Ryuk', 'Unknown']),
      description: 'Malware family detected by YARA',
      context_weight: 9
    },
    'malware.static.entropy.overall_score': {
      type: 'float',
      generator: () => faker.number.float({ min: 0, max: 8, fractionDigits: 3 }),
    ...
    'malware.classification.av_detection_ratio': {
      type: 'float',
      generator: () => faker.number.float({ min: 0, max: 1, fractionDigits: 2 }),
  ...
  geolocation_intelligence: {
    ...
    'geo.patterns.travel_velocity_kmh': {
      type: 'float',
      generator: () => faker.number.float({ min: 0, max: 2000, fractionDigits: 2 }),
  ...
  incident_response: {
    ...
    'incident.impact.data_loss_gb': {
      type: 'float',
      generator: () => faker.number.float({ min: 0, max: 10000, fractionDigits: 2 }),
    ...
    'incident.response.network_captures_gb': {
      type: 'float',
      generator: () => faker.number.float({ min: 0, max: 500, fractionDigits: 2 }),
    ...
    'incident.attribution.threat_actor_suspected': {
      type: 'string',
      generator: () => faker.helpers.arrayElement(['APT1', 'Lazarus', 'FIN7', 'Carbanak', 'Unknown', 'Insider']),
      description: 'Suspected threat actor',
      context_weight: 8
    },
    'incident.attribution.confidence_level': {
      type: 'string',
      generator: () => faker.helpers.arrayElement(['low', 'medium', 'high', 'confirmed']),
      description: 'Attribution confidence level',
      context_weight: 8
    },
    'incident.attribution.motivation_assessed': {
      type: 'string',
      generator: () => faker.helpers.arrayElement(['financial', 'espionage', 'disruption', 'hacktivism', 'unknown']),
      description: 'Assessed threat actor motivation',
      context_weight: 8
    },
    'incident.attribution.sophistication_level': {
      type: 'string',
      generator: () => faker.helpers.arrayElement(['low', 'medium', 'high', 'nation-state']),

...
program
  ...
  .action(async (dir) => {
    // Hardcoded dataset directory names generated by create-risk-engine-datasets
    const DATASET_DIRS = [
      dir,
      //'small_lowCardinality',
      //'medium_lowCardinality',
      // 'large_lowCardinality',
      // 'small_midCardinality',
      // 'medium_midCardinality',
      // 'large_midCardinality',
      // 'small_highCardinality',
      // 'medium_highCardinality',
      // 'large_highCardinality',
      // 'small_extremeCardinality',
    ];
